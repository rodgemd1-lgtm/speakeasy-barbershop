...
> Extracted from `https://speakeasybarberlounge.com` on April 22, 2026
...
**Description:** Get the best men's haircut in Denver at our top-rated barbershop. Experience expert styling and a fresh look. Book your appointment today!

## Section Roles

Reading order (top→bottom): nav → nav → feature-grid → nav → footer → nav
...
| 1 | nav | — | 0.9 |
| 2 | nav | — | 0.9 |
| 3 | feature-grid | A $10 gift to first time clients from the Speakeasy team
 | 0.8 |
| 4 | footer | Business hours: | 0.95 |
| 5 | nav | — | 0.9 |
...
**Label:** `flat-illustration` (confidence 0.492)
**Counts:** total 20, svg 17, icon 0, screenshot-like 0, photo-like 1
