...
REPO_NAME='speakeasy-barbershop'
REPO_SLUG='speakeasy-barbershop'
DEFAULT_BRANCH='main'
GITHUB_URL='https://github.com/rodgemd1-lgtm/speakeasy-barbershop'
GITHUB_RAW_BASE='https://github.com/rodgemd1-lgtm/speakeasy-barbershop/raw/main'
QNAP_CLONE='ssh://git@nas94f2ae.tail4d96b3.ts.net:2222/rig/speakeasy-barbershop.git'
